...
while True:
    try: 
        conn = psycopg2.connect(host="localhost", database="fastapi", user="postgres", password="Klaus2064", cursor_factory=RealDictCursor)
        cursor = conn.cursor() # utiliser pour effectuer des requête sql
